-- HumanAgentWiki — PostgreSQL schema
...
CREATE TABLE IF NOT EXISTS chunks (
    ...
    embedding   double precision[],     -- embedding vector; pgvector-free fallback storage
...
-- Indexes: full-text (GIN) + links (GIN) + trigram (fuzzy).
