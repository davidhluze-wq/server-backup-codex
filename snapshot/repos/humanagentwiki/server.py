"""MCP server over your notes — hybrid semantic + keyword search.
...
def search(query, k=8, category="", node_type=""):
    ...
    try:
        ...
        # pgvector is not installed on some hosts; keep the web UI usable with
        # keyword/trigram search until the extension is available.
        pass
